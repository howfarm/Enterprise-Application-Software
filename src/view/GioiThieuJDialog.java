...
public class GioiThieuJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("Đây là phần mềm quản lý cửa hàng bán đồ lưu niệm.\nKhi sử dụng phần mềm này, nhân viên có thể dễ dàng chỉnh sửa sản phẩm hay xem thống kê.");
